...
class Journal extends StatefulWidget {
  ...
  Journal(this.category, this.screen);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: (){
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (_)=> widget.screen));
          },
        ),
        ...
        actions: [
          IconButton(onPressed: () {
            Provider.of<FirebaseWork>(context, listen:false).Save(context, {
              ...
              "image": imageSelected,
            }).whenComplete(() => Provider.of<FirebaseWork>(context,listen:false).journalIncrement(context)).whenComplete(() => Navigator.pop(context));
