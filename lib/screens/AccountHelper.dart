          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Divider(color: Colors.pinkAccent,thickness: 3,),
                Padding(
  ...
  Widget footerProfile(BuildContext context, dynamic snapshot) {
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          children: [
        Provider.of<FirebaseWork>(context,listen:false).getInitUserGoalCount!=null?Text('Your completed goals: ${Provider.of<FirebaseWork>(context,listen:false).getInitUserGoalCount.toString()}',style: TextStyle(color: Colors.black,fontSize: 30),):Text("Opps! No goals to display, create goals from boost confidence",style: TextStyle(color: Colors.white, fontSize:20),),
            Provider.of<FirebaseWork>(context,listen: false).getInitUserJournalCount!=null?Text("Your written journals: ${Provider.of<FirebaseWork>(context,listen:false).getInitUserJournalCount.toString()}",style: TextStyle(color: Colors.black,fontSize: 30),):Text("Opps! No written journals to display, create journals from Journal Tab",style: TextStyle(color: Colors.white, fontSize:20),),
