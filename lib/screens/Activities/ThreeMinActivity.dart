    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: (){
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (_)=>SelfAwareness()));
          },
        ),
          ...
          children: [
            Center(
              child: Container(
                ...
                child: Center(child: TimeDuration1==60?Text("Hit the play button and follow the instructions given in time panel",style: TextStyle(color: Colors.pink,fontSize: 25),):Text("You are about feel relaxed and happy",style: TextStyle(color: Colors.yellowAccent,fontSize: 25),)),
              ),
            ),
