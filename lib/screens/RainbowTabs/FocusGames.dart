                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text('Memorize the numbers and type them correctly in the given time\n      All the best!',
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text('Memorize the words and type them correctly in the given time\n      All the best!', style: TextStyle(fontFamily: "Poppins", fontSize: 18,color: Colors.greenAccent) )
                        ],
                      ),
                    ),
                    Spacer(),
